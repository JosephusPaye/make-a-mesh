...
class Gradient {
    constructor(seed = 5, record = {}) {
        ...
        /*e(this, "isStatic", o.disableAmbientAnimations()),*/ e(
            ...
            e(this, "t", 1253106),
            e(this, "last", 0),
            e(this, "width", 1920), // Extra (Josephus): Hardcoded width
            e(this, "minWidth", 1920), // Extra (Josephus): Hardcoded width
            e(this, "height", 1080), // Extra (Josephus): Hardcoded height
            ...
            e(this, "amp", 320),
            e(this, "seed", seed), // Extra (Josephus): Made seed configurable via constructor parameter, instead of 5
            e(this, "freqX", 14e-5),
            e(this, "freqY", 29e-5),
            ...
            e(this, "resize", () => {
                (this.width = 1920), // Extra (Josephus - hardcoded width to 1920, instead of window.innerWidth)
            ...
            e(this, "animate", (e) => {
                // Extra (Josephus): Commented out a few lines, as they were causing blank frames in the animation when exported
        ...
        //   /*this.isIntersecting && */ (this.conf.playing || this.isMouseDown) &&
                    ...
                    // Extra (Josephus): Record if we have recording enabled
                    this.record?.recordingState?.value === 'recording' && this.record.capturer.capture(this.el);
            }),
          ...
          /*this.isIntersecting && */ !this.isLoadedClass &&
            ...
            e(this, "initGradient", (selectorOrElement) => {
                // Extra (Josephus): changed parameter to take in a selector or element
                this.el = typeof selectorOrElement === "string" ? document.querySelector(selectorOrElement) : selectorOrElement;
                this.connect();
                return this;
            });
    }
